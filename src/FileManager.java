...
public class FileManager extends AbstractFileManager {
    ...
    byte[] myByteArray = new byte[759843025];
    int currentblock = 0;
        ...
        while (!EOF) {
            try {
                ...
                if (eofCounter >= 4) {
                    ...
                    /* only for debug purposes */
                    System.out.println(new String(nationality));
					...
					/* only for debug purposes */
                    System.out.println(new String(vo));
					...
					/* only for debug purposes */
                    System.out.println(new String(takings));
					...
					/* only for debug purposes */
                    System.out.println(new String(directorName));
					...
					/* only for debug purposes */
                    System.out.println(new String(directorSurname));
					...
					/* only for debug purposes */
                    System.out.println(new String(directorNickname));
					...
					/* only for debug purposes */
                    System.out.println(new String(screenwriterName));
					...
					/* only for debug purposes */
                    System.out.println(new String(screenwriterSurname));
					...
					/* only for debug purposes */
                    System.out.println(new String(screenwriterNickname));
                    ...
                    for (int k = 0; k < 8; k++) {
                        ...
                        if (actorNicknameLength[k] != 0) {
                            ...
                            recordSize = recordSize + 1;
							/* only for debug purposes */
                            System.out.println(new String(actorName[k]));
							/* only for debug purposes */
                            System.out.println(new String(actorSurname[k]));
							/* only for debug purposes */
                            System.out.println(new String(actorNickname[k]));
                        } else {
                            realCounter = realCounter + 1;
                            recordSize = recordSize + 1;
                            actorExist[k] = 0;
